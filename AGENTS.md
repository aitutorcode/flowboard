...
- An MVP of a Kanban-style Project Management application as a web app, called FlowBoard
...
- Accent Yellow: `#FFC72C` - secondary highlights, accent lines
- Dark Navy: `#0F1729` - main headings, dark surfaces
- Background Lavender: `#DCE0EE` - app background, soft surfaces
- Gray Text: `#6B7280` - supporting text, labels
